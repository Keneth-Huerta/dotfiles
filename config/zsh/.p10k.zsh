# Generated by Powerlevel10k configuration wizard on 2025-08-17 at 21:40 CST.
...
# angled separators, slanted heads, blurred tails, 2 lines, solid, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    # =========================[ Line #2 ]=========================
    newline                 # \n
    prompt_char             # prompt symbol con colores rojos
  )
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # Solo los entornos que realmente uses
    virtualenv              # python virtual environment
    nvm                     # node.js version from nvm
    
    # Herramientas de desarrollo relevantes
    kubecontext             # current kubernetes context (si usas k8s)
    context                 # user@hostname
    
    # File managers si los usas
    ranger                  # ranger shell
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%88F╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%88F├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%88F╰─'
  # Connect right prompt lines with these symbols.
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%88F─╮'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%88F─┤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%88F─╯'
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=88
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=196        # Rojo brillante
  # Custom icon.
  ...
  # Red prompt symbol if the last command succeeded (tema rojo consistente).
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=52             # Rojo oscuro
  ...
  function my_git_formatter() {
    ...
    local      clean='%196F' # Rojo brillante para clean
    local   modified='%160F' # Rojo-magenta para modificado
    local  untracked='%124F' # Rojo medio para untracked
    local conflicted='%88F'  # Rojo oscuro para conflictos
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_VCS_PREFIX='%15Fon '
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=88
  ...
  # CPU architecture color - tema rojo.
  typeset -g POWERLEVEL9K_CPU_ARCH_FOREGROUND=15        # Blanco
  typeset -g POWERLEVEL9K_CPU_ARCH_BACKGROUND=124       # Rojo medio

  # Forzar mostrar la arquitectura incluso si es x86_64
  typeset -g POWERLEVEL9K_CPU_ARCH_X86_64_CONTENT_EXPANSION='x86_64'
  ...
  # IP color - tema rojo.
  typeset -g POWERLEVEL9K_IP_BACKGROUND=88          # Rojo oscuro
  typeset -g POWERLEVEL9K_IP_FOREGROUND=15          # Blanco
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='$P9K_IP_IP'  # Solo mostrar IP, sin bandwidth
  # Show information for the first network interface whose name matches this regular expression.
  # Run `ifconfig` or `ip -4 a show` to see the names of all network interfaces.
  typeset -g POWERLEVEL9K_IP_INTERFACE='(wlp|enp|eth|wlan).*'  # Incluye wireless y ethernet
  # Custom icon.
  ...
  # Format for the current time: 21:51. See `man 3 strftime`.
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%H:%M}'  # Formato 24h sin segundos
